...
ActiveRecord::Schema[8.1].define(version: 2026_09_03_115350) do
  ...
  create_table "openings", force: :cascade do |t|
    t.string "against"
    t.string "color"
    t.text "cons", default: [], null: false, array: true
    t.datetime "created_at", null: false
    t.text "description"
    t.json "explications"
    t.text "gendesc"
    ...
    t.string "logo"
    t.string "name"
    t.text "pros", default: [], null: false, array: true
    t.string "suite_de_coups"
    t.datetime "updated_at", null: false
    t.string "video_url"
  end
